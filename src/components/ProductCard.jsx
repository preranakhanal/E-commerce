...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded relative border transform transition duration-300 hover:scale-105">
      <img
        src={product.image}
        alt={product.name}
      ...
      <div className="flex items-center mt-2">
        ...
        <FaStar className="text-yellow-500" />
        <FaStar className="text-yellow-500" />
        <FaStar className="text-gray-300" /> {/* Example of an empty star */}
      </div>
      {/* Add to Cart Button */}
